...
class Review(BaseModel):
    ...
    sentiment: int = Field(description="The sentiment of the review, where 1 is positive and -1 is negative")
    ...
    name : Optional[str] = Field(description="The name of the reviewer, if mentioned")
